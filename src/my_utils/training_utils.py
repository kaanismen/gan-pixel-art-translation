...
def parse_args_paired_training(input_args=None):
   ...
   """
    ...
    parser.add_argument("--lambda_palette", default=0.0, type=float, help="weight for the palette loss")
    parser.add_argument("--palette_loss", default="none", choices=["none", "active"], help="whether to enable palette loss" )
...
def parse_args_unpaired_training():
   ...
   """
    ...
    parser.add_argument(
        ...
        default=16,
        type=int,
        help="number of bins for the soft histogram",
    )
    parser.add_argument(
        "--sigma",
        default=0.01,
        type=float,
        help="Gaussian width for soft‐binning",
    )
...
def build_transform(image_prep):
    ...
    elif image_prep == "resize_32_randomcrop_32x32_hflip":  # ✅ New Fix
        T = transforms.Compose([
    ...
    elif image_prep == "resize_64_randomcrop_64x64_hflip":  # ✅ New Fix
        T = transforms.Compose([
            transforms.Resize((64, 64), interpolation=Image.LANCZOS),
